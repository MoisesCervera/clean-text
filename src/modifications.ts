...
export const functions: Modifications = {
    ...
    "Normalize Punctuation Spaces": cleanText.normalizePunctuationSpaces,
...
export const aliases: Record<ModificationType, string[]> = {
    ...
    "Normalize Punctuation Spaces": ["normalize-punctuation-spaces", "punctuation-space-normalization"],
